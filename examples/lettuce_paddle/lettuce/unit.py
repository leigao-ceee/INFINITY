...
class UnitConversion:
    ...
    Conversion methods should work for floats, tensors and np.arrays.
    """
    ...
    def convert_density_lu_to_pressure_pu(self, density_lu):
        cs = self.lattice.cs if isinstance(density_lu, paddle.Tensor) else self.lattice.stencil.cs
    ...
    def convert_pressure_pu_to_density_lu(self, pressure_pu):
        cs = self.lattice.cs if isinstance(pressure_pu, paddle.Tensor) else self.lattice.stencil.cs
